...
// crear variable reactiva con objeto thStore
...
<template>
  ...
  <div
    ...
    class="wrapper transition ease-linear"
  >
        ...
        >
          <div class="relative">
            ...
            >
              ...
              />
              <SunIcon
                v-if="theme.isDark === false"
                class="w-full h-full text-yellow-500 p-1"
              />
            </div>
          </div>
          ...
          <div
            v-bind:class="theme.isDark === true ? 'dark' : ' '"
    ...
    <div
      v-bind:class="theme.isDark === true ? 'dark' : ' '"
      class="todo flex-1 lg:w-2/3 xl:w-2/5 w-full px-7"
    >
      <RouterView />
    </div>
  </div>
  ...
  >
    <div class="unknowncode">
      <span class="font-light mx-2">by</span>unknown<span
    ...
    <a
      class="text-sm font-normal text-white cursor-pointer flex flex-row justify-around items-center"
